...
* 
* @param args[3] Y if user want to receive polar coordinates, N if not
*/
public static void main(String[] args)
{
 ...
 if (point.Conv() == 'Y') //prints coordinates as polar if user wants to
 {
	 point.convertStorageToPolar();
	 System.out.println("\nAfter asking to receive as Polar:\n" + point);
	 point.convertStorageToCartesian();
 }
}
...
private static PointCP getInput() throws IOException
{
 ...
 for (int i = 0; i < 4; i++)
 {
   while (!(isOK))
   {
     ...
     else // Second and third arguments
     {
    	 ...
    	 if (i == 3) //asks user if he wants to receive polar coordinates
    	 {
    		 System.out.print("Receive the polar Coordinates as well?, Y / N :");
    	 }
     }
     ...
     try
     {
       ...
       else  // Second and third arguments
       {
         ...
         if (i == 3) //fourth argument -- if user want to get polar coordinates
             {
               ...
               {
                 conv = theInput.toUpperCase().charAt(0);
 ...
 return (new PointCP(coordType, a, b, conv));
}
}